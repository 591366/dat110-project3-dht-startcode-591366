...
//		int modId = id.mod(new BigInteger("10")).intValue();
//		int modLower = lower.mod(new BigInteger("10")).intValue();
//		int modUpper = upper.mod(new BigInteger("10")).intValue();
//
//		int newUpper = modUpper;
//		if (modUpper < modLower)
//			newUpper = modUpper + 10;
//		int[] intervalArray = new int[(newUpper - modLower) + 1];
//		int i = 0;
//		for (int n = modLower; n <= newUpper; n++) {
//			intervalArray[i++] = n % 10;
//		}
//
//		return findPos(modId, intervalArray) != -1;
//		else if(findPos(modLower, intervalArray) == -1) return false;
//		else if(findPos(modUpper, intervalArray) == -1) return false;
//		else if((findPos(modLower, intervalArray) < findPos(modId, intervalArray)) && (findPos(modId, intervalArray) <= findPos(modUpper, intervalArray))) {
//			return true;
//		}
//		
//		return false;
	...
	public static int findPos(int val, int[] array) {
